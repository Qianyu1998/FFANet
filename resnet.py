...
def resnet50(pretrained=True, root=root, **kwargs):
    ...
    if pretrained:
        ...
        # copy_weight = pretrained_dict
        # for key in list( copy_weight.keys()):
        #     if key[9:19].startswith('downsample'):
        #         del copy_weight[key]
        #         print(f'succdssful delet {key}')
